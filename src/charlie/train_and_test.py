# Note to muchang: The only difference to this file is adding balanced accuracy. The rest of the code is the same.
...
def _train_or_test(model, dataloader, optimizer=None, class_specific=True, use_l1_mask=True,
    ...
    log('\tbalanced accu:\t{0}%'.format(torch.mean(class_correct_counts / class_guess_counts).item() * 100))
